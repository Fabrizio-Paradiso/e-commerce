const ItemCount = ({count, availableStock, handleCount}) => {
    ...
    return (
        <div style={{paddingTop:"1.5rem"}}>
            <button value="1" type="button" class="d-flex justify-content-around align-items-center" style={{width:"70px", backgroundColor:"#F58A1F" , height:"32px" , boxShadow: "0px 1px black", border:"0.06rem black solid"}}>
