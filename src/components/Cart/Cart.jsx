        ...
        <>
            {
                cartList.length?
                    ...
                    <div className="row" >
                        ...
                        <div className="cart-footer col-3 text-center d-flex flex-column align-items-center" style={{boxShadow:" rgba(0, 0, 0, 0.35) 0px 5px 15px", margin:"3rem 2rem 0 2.9rem"}}>
                            <h2 style={{paddingTop:"1rem", fontWeight:"bold", borderBottom:"2rem", color:"#F58A1F", textShadow: "1.2px 1px 0.5px gray"}}>Summary</h2>
                            <h3 style={{paddingTop:"1rem", fontSize:"1.5rem", fontWeight:"bold"}}>Subtotal: {getTotalPrice()} <img src={dai} alt="coin" style={{height:"25px" , marginBottom:"0.3rem"}}/> </h3>
                            <h3 style={{paddingTop:"1rem", fontSize:"1.5rem", fontWeight:"bold"}}>Shipping: {shipping} <img src={dai} alt="coin" style={{height:"25px" , marginBottom:"0.3rem"}}/> </h3>
                            <h3 style={{paddingTop:"1rem", fontSize:"1.5rem", fontWeight:"bold"}}>Taxes: {getTaxes()} <img src={dai} alt="coin" style={{height:"25px" , marginBottom:"0.3rem"}}/> </h3>
                            <h3 style={{paddingTop:"1rem", fontSize:"1.5rem", fontWeight:"bold"}}>Total: {getFinalPrice()} <img src={dai} alt="coin" style={{height:"25px" , marginBottom:"0.3rem"}}/> </h3>
                            <button style={{all:"unset", marginTop:"1.8rem",cursor:"pointer",backgroundColor:"#CA0B00", width:"150px", height:"30px" , boxShadow: "0px 1px black", border:"0.06rem black solid"}} onClick={clearCart}><span style={{ fontSize:"1.1rem", fontWeight:"bold", borderBottom:"2rem" ,color:"#fff", textShadow: "1.2px 1px 0.5px black"}}>Empty Cart<img src={clear} alt="shop-bag" style={{height:"23px", paddingLeft:"0.3rem"}}/></span></button>
                            <Link to={"/form"} style={{textDecoration:'inherit', color:'inherit'}}>   
                                <button style={{all:"unset", marginTop:"1.8rem", cursor:"pointer",backgroundColor:"#6AA303", width:"150px", height:"30px" , boxShadow: "0px 1px black", border:"0.06rem black solid"}}><span style={{ fontSize:"1.1rem", fontWeight:"bold", borderBottom:"2rem" ,color:"#fff", textShadow: "1.2px 1px 0.5px black"}}>Purchase <img src={purchase} alt="shop-bag" style={{height:"23px", paddingLeft:"0.1rem"}}/></span></button>
                            </Link>
                        </div>  
                    </div>
                    </>
