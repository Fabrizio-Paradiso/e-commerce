...
export const ItemDetail = ({img,price,name,description,stock}) => {
  ...
  const showBuy = (count) => {
    console.log(`${count} products have been added to cart`)
  }
    ...
    <>
        <div className='item-detail-container row align-items-center'>
          <div className='item-detail-image col-6 text-end my-4'>
            <img src={img} alt={name} style={{width: "500px", height: "550px" , padding:"100px", backgroundColor:"white", boxShadow:" rgba(0, 0, 0, 0.35) 0px 5px 15px"}}/>  
          </div>
        ...
        <div className='item-detail-description d-flex-column col-3 text-center my-4' >
          ...
          <ItemCount initial = {0} stockInicial = {stock} onAdd={showBuy}/>
        </div>
      </div>
    </>
  )
